...

{
    ...
    $sql = "Select * from admin_tble where email='$txtEmail' and xpassword = '$txtPassword'";
     ...
     if ($num != 0)
         {
             ...
             location.href='adminwelcome.php?sql=$customerID';
             </script>";
 ...
 
         {
            $sql="Incorrect login details! Try again";
             echo " <script language='JavaScript'>
             location.href='administrator.php?sql=$sql';
             </script>";
                ...
                <table height="200px" bgcolor="#000" width="100%">
                    ...
                    <tr>
                        ...
                        <h2>Login</h2>
                                ...
                                <form action="administrator.php?pg=2" method="post" enctype="multipart/form-data">
                                <table>
                                    <tr>
                                        <td>Email Address</td>
